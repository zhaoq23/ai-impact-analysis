...
3. [Article Clean-up and Filtering](#article-clean-up-and-filtering)
4. [Sentiment Analysis](#sentiment-analysis)  
   - [Steps](#steps)  
   - [Results](#results)  
   - [Sentiment Analysis Over Time](#sentiment-analysis-over-time)  
   - [Sentiment Analysis with Keyword Pattern](#sentiment-analysis-with-keyword-pattern)
5. [Topic Detection Based on LDA](#topic-detection-based-on-lda)  
   - [Positive Sentiment](#positive-sentiment)  
   - [Negative Sentiment](#negative-sentiment)
6. [Entity Analysis NER with spaCy](#entity-analysis-ner-with-spacy)  
   ...
   - [Profession Trends](#profession-trends)  
   - [People Trends](#people-trends)  
...
## Sentiment Analysis with Keyword Pattern
